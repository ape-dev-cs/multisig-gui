var i0=Object.defineProperty,r0=Object.defineProperties;var s0=Object.getOwnPropertyDescriptors;var N=Object.getOwnPropertySymbols;var V=Object.prototype.hasOwnProperty,K=Object.prototype.propertyIsEnumerable;var I=(e,t,f)=>t in e?i0(e,t,{enumerable:!0,configurable:!0,writable:!0,value:f}):e[t]=f,p=(e,t)=>{for(var f in t||(t={}))V.call(t,f)&&I(e,f,t[f]);if(N)for(var f of N(t))K.call(t,f)&&I(e,f,t[f]);return e},m=(e,t)=>r0(e,s0(t));var J=(e,t)=>{var f={};for(var o in e)V.call(e,o)&&t.indexOf(o)<0&&(f[o]=e[o]);if(e!=null&&N)for(var o of N(e))t.indexOf(o)<0&&K.call(e,o)&&(f[o]=e[o]);return f};var O=(e,t,f)=>(I(e,typeof t!="symbol"?t+"":t,f),f);import{I as l0,W as c0,u as v,r as s,C as M,p as d0,s as l,j as n,a as b0,R as Q,b as u0,c as p0,d as g0,e as m0,F as h0,f as d,g as y0,h as x0,i as h,L as w0,O as v0,k as T0,t as x,l as S0,m as C0,n as P0,o as E0,q as k0,v as N0,w as Z,x as M0,y as A0,T as $0,B as D0,z as W0,A,D as B0,E as R0,G as I0}from"./vendor.db049a92.js";const O0=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function f(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerpolicy&&(i.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?i.credentials="include":a.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(a){if(a.ep)return;a.ep=!0;const i=f(a);fetch(a.href,i)}};O0();const L={POLYGON_MAINNET:137,POLYGON_TESTNET:80001,DAPPTOOLS:99},L0={[L.POLYGON_MAINNET]:"https://polygon.g.alchemy.com/v2/VMBpFqjMYv2w-MWnc9df92w3R2TpMvSG",[L.POLYGON_TESTNET]:"https://polygon-mumbai.g.alchemy.com/v2/VMBpFqjMYv2w-MWnc9df92w3R2TpMvSG",[L.DAPPTOOLS]:"http://localhost:8545"},S=new l0({}),z0=new c0({rpc:L0,qrcode:!0,clientMeta:{name:"Multisig Interface",description:"Clipto",url:"",icons:[]}});function F0(){const{activate:e,active:t}=v(),[f,o]=s.exports.useState(!1);return s.exports.useEffect(()=>{S.isAuthorized().then(a=>{a?e(S,void 0,!0).catch(()=>{o(!0)}):o(!0)})},[]),s.exports.useEffect(()=>{!f&&t&&o(!0)},[f,t]),f}const _0=()=>{const{account:e,library:t}=v(),f=s.exports.useCallback(async i=>{if(!!t)try{return await(t==null?void 0:t.lookupAddress(i))||null}catch{return null}},[t]),[o,a]=s.exports.useState(void 0);return s.exports.useEffect(()=>{if(!e){a(void 0);return}(async()=>{const r=await f(e);if(r){a(r);return}else{a(null);return}})()},[e,f]),o};function H0(e=!1){const{active:t,error:f,activate:o}=v();s.exports.useEffect(()=>{const{ethereum:a}=window;if(a&&a.on&&!t&&!f&&!e){const i=()=>{console.log("Handling 'connect' event"),o(S)},r=c=>{console.log("Handling 'chainChanged' event with payload",c),o(S)},g=c=>{console.log("Handling 'accountsChanged' event with payload",c),c.length>0&&o(S)},u=c=>{console.log("Handling 'networkChanged' event with payload",c),o(S)};return a.on("connect",i),a.on("chainChanged",r),a.on("accountsChanged",g),a.on("networkChanged",u),()=>{a.removeListener&&(a.removeListener("connect",i),a.removeListener("chainChanged",r),a.removeListener("accountsChanged",g),a.removeListener("networkChanged",u))}}},[t,f,e,o])}const q0=1130,e0=`${q0}px`,z={upToExtraSmall:500,upToSmall:720,upToMedium:960,upToLarge:1280,upToExtraLarge:1500},j0=Object.keys(z).reduce((e,t)=>(e[t]=(f,o,a)=>M`
  ...
  `}),V0=(e,t=6,f=4)=>`${e.slice(0,t)}...${e.slice(-1*f)}`,K0=e=>(t,f,o)=>e((a,i)=>{const r=typeof a=="function"?d0(a):a;return t(r,i)},f,o),F=l.div`
  height: 40px;
  min-height: 40px;
  max-height: 40px;
  width: 40px;
...
`,J0=e=>{const t=f=>{const o=f.substring(2,10),a=parseInt(o.substring(0,2),16),i=parseInt(o.substring(2,4),16),r=parseInt(o.substring(4,6),16);return`rgb(${a}, ${i}, ${r})`};return e.url?n(F,{style:{background:`url(${e.url})`}}):e.address?n(F,{style:{background:`linear-gradient(134.17deg, ${t(e.address.substring(2,10))} 0%, ${t(e.address.substring(10,18))} 86.27%)`}}):n(F,{})},Q0=l.button`
  ...
  `}
`,T=e=>{var a,i;const t=s.exports.useRef(null),{buttonProps:f,isPressed:o}=b0(e,t);return n(Q0,m(p({variant:(a=e.variant)!=null?a:"primary",size:(i=e.size)!=null?i:"large",isDisabled:e.isDisabled},f),{isPressed:o,ref:t,style:e.style,children:e.children}),e.key)},Z0=e=>{const{title:t,children:f,containerStyles:o}=e,a=Q.useRef(null),{overlayProps:i,underlayProps:r}=u0(e,a);p0();const{modalProps:g}=g0(),{dialogProps:u,titleProps:c}=m0(e,a);return n("div",m(p({style:{position:"fixed",zIndex:100,top:0,left:0,bottom:0,right:0,background:"rgba(0, 0, 0, 0.5)",display:"flex",alignItems:"center",justifyContent:"center"}},r),{children:n(h0,{contain:!0,restoreFocus:!0,autoFocus:!0,children:d(y0.div,m(p(p(p({},i),u),g),{ref:a,style:p({background:"#000000",color:"#ffffff",padding:"40px 16px",marginBottom:64,borderRadius:16,boxShadow:`0.3px 0.3px 2.2px rgba(0, 0, 0, 0.02), 0.7px 0.8px 5.3px rgba(0, 0, 0, 0.028),
...
`,_=x0(K0(e=>({showDialog:!1,hasTriedEagerConnecting:!1,setShowDialog:t=>{e(f=>{f.showDialog=t})},setHasTriedEagerConnecting:t=>{e(f=>{f.hasTriedEagerConnecting=t})}}))),re=()=>{const{activate:e,account:t,deactivate:f}=v(),o=_(b=>b.showDialog),a=_(b=>b.setShowDialog),i=_(b=>b.setHasTriedEagerConnecting),r=_0(),g=F0(),[u,c]=s.exports.useState(null);s.exports.useEffect(()=>{i(g)},[g,i]);const[C,w]=s.exports.useState(void 0),B=s.exports.useCallback(async()=>{var b,k;c(null),w("metamask");try{await e(S,void 0,!0)}catch(y){console.log(y.name),y.name==="NoEthereumProviderError"||((b=y.message)==null?void 0:b.includes("No Ethereum provider was found"))?c("No MetaMask detected."):y.message.includes("Already processing eth_requestAccounts")||y.message.includes("Request of type 'wallet_requestPermissions'")?c("Check MetaMask for an existing login request"):y.message.includes("The user rejected the request")?c("The MetaMask login was closed, try connecting again"):(c((k=y.message)!=null?k:"Something went wrong logging in"),console.log(y,Object.keys(y))),w(void 0);return}a(!1),setTimeout(()=>{w(void 0)},1500)},[e,a]),R=s.exports.useCallback(async()=>{var b;c(null),w("wc");try{await e(z0,void 0,!0)}catch(k){w(void 0),c((b=k.message)!=null?b:"Something went wrong logging in with WalletConnect"),console.log(k);return}a(!1),setTimeout(()=>{w(void 0)},1500)},[e,a]),U=s.exports.useCallback(async()=>{f()},[f]);return H0(!g),d(h,{children:[n(fe,{children:d(oe,{children:[n(ae,{children:n(w0,{to:"/",children:n(te,{})})}),g&&d(h,{children:[!t&&n(n0,{children:n(T,{size:"small",variant:"secondary",onPress:()=>a(!0),children:"Connect Wallet"})}),t&&n(h,{children:d(n0,{onClick:U,children:[n(ie,{style:{marginRight:16},children:r!=null?r:V0(t,6,4)}),n(J0,{address:t})]})})]})]})}),o&&n(v0,{children:n(Z0,{containerStyles:{},isOpen:!0,onClose:()=>a(!1),isDismissable:!0,children:d(h,{children:[n("div",{style:{marginBottom:16,fontWeight:700,fontSize:18,textAlign:"left"},children:"Connect a wallet"}),u&&n("div",{style:{marginBottom:12,color:"#FF6868",textAlign:"left"},children:u}),n(T,{variant:"secondary",style:{marginBottom:16,minWidth:310},isDisabled:C==="metamask",onPress:B,children:n("div",{style:{display:"flex",verticalAlign:"middle"},children:C==="metamask"?n(h,{children:"Confirm in your wallet"}):"Continue with Metamask"})}),n(T,{variant:"secondary",style:{marginBottom:16,minWidth:310},isDisabled:C==="wc",onPress:R,children:n("div",{style:{display:"flex",verticalAlign:"middle"},children:C==="wc"?n(h,{children:"Confirm in your wallet"}):"Continue with mobile wallet"})})]})})})]})},H=l.div`
  height: ${P};
  width: 100%;
  min-height: ${P};
  max-height: ${P};
...
`,Te=l(Y)`
  ...
  color: white;
  margin-bottom: 4px;
`,a0=()=>{const e=Z();v();const[t,f]=s.exports.useState("");return n(h,{children:d(j,{children:[n(H,{}),n(G,{children:n(X,{children:d(ve,{children:[n(Te,{children:"Deploy a new multisig"}),n(T,{onPress:()=>{e("/deploy")},style:{maxWidth:"180px",marginTop:"30px",marginBottom:"30px"},children:"Deploy"}),n(f0,{}),n("div",{style:{marginBottom:24,marginTop:24},children:n(E,{onChange:o=>f(o),label:"Or use an existing one",placeholder:"0x34cfac646f301356faa8b21e94227e3583fe3f5f"})}),n(T,{onPress:()=>e(`/multisig/${t}`),style:{marginBottom:"16px",maxWidth:"180px"},children:"Use"})]})})})]})})};function Se(e){const t=new B0(e);return t.pollingInterval=12e3,t}function Ce(){return n(M0,{getLibrary:Se,children:d(A0,{theme:U0,children:[n($0,{}),d(D0,{children:[n(re,{}),d(W0,{children:[n(A,{path:"/multisig-gui/",element:n(a0,{})}),n(A,{path:"/multisig-gui/deploy",element:n(we,{})}),n(A,{path:"/multisig-gui/multisig/:contract",element:n(ye,{})}),n(A,{index:!0,element:n(a0,{})})]})]})]})})}window.global=window;window.Buffer=window.Buffer||R0.Buffer;I0.render(n(Q.StrictMode,{children:n(Ce,{})}),document.getElementById("root"));
